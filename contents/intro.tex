...
Its Rust-based TCB also allows for a flexible codebase while maintaining a
...
prevented, except for places where unsafe Rust is used. Hence alleviating the
need for developers to manually audit the entire program.
