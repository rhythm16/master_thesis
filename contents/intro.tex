...
We have developed \rustsec{} for Linux 5.15, a Rust-based reimplementation of
the Linux 4.18-based SeKVM \cite{sekvm}.
\rustsec{} is implemented mainly by rewriting SeKVM's verified TCB
\textit{\secore{}} in Rust, which is called \textit{\rustcore{}}.
% KRUSTVM DESCRIPTION
...
Moreover, updating the Linux version enables us to take advantage of new kernel
features including Link-Time-Optimization (LTO) and energy-aware scheduling.
