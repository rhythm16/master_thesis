...
Our work explores implementing a Linux KVM's TCB in Rust, so that the resulting hypervisor
...
We have developed \rustsec{}, a Rust-based reimplementation of SeKVM \cite{sekvm}.
...
%protect VM confidentiality and integrity against the large and untrusted
%hypervisor codebase that encompasses KVM’s host Linux kernel.
Then we identified and overcame the challenges that arose when trying to
